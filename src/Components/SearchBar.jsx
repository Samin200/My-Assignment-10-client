    ...
    <>
      ...
      <div className="sm:hidden w-full px-4 py-2">
        <form
          ...
          className="flex items-center bg-[#f44040] rounded-full px-3"
        >
          <svg
          ...
          <input
            ...
            className="flex-1 bg-transparent outline-none text-white px-3 py-2 placeholder:text-gray-200"
          />
          {searchValue && (
            <button
              type="button"
      ...
      {}
      <div className="hidden sm:flex p-5 overflow-hidden w-10 h-10 hover:w-[270px] hover:bg-[#f44040] shadow-[2px_2px_20px_rgba(0,0,0,0.08)] rounded-full items-center group duration-300 relative right-2">
